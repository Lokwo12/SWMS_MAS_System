...
send(var_To,send_message(pickup_request(var_Bin,var_ReqId,var_Token),var_Ag)):-tell(var_To,var_Ag,send_message(pickup_request(var_Bin,var_ReqId,var_Token))),send_m(var_To,send_message(pickup_request(var_Bin,var_ReqId,var_Token),var_Ag)).

send(var_To,send_message(assignment(var_Bin,var_ReqId,var_Token),var_Ag)):-tell(var_To,var_Ag,send_message(assignment(var_Bin,var_ReqId,var_Token))),send_m(var_To,send_message(assignment(var_Bin,var_ReqId,var_Token),var_Ag)).
...
call_cfp(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_187415,var_Ontology,_187419),_187409),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_cfp(var_A,var_C,var_Ag,_187453)),a(message(var_Ag,propose(var_A,[_187453],var_AgI))),retractall(ext_agent(var_Ag,_187491,var_Ontology,_187495)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_187289,var_Ontology,_187293),_187283),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,accept_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_187359,var_Ontology,_187363)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_187177,var_Ontology,_187181),_187171),not(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,reject_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_187233,var_Ontology,_187237)).
...
call_cancel(var_A,var_Ag):-if(clause(high_action(var_A,var_Te,var_Ag),_186741),retractall(high_action(var_A,var_Te,var_Ag)),true),if(clause(normal_action(var_A,var_Te,var_Ag),_186775),retractall(normal_action(var_A,var_Te,var_Ag)),true).
...
refused_message(var_To,var_M):-clause(eliminated_message(var_M,var_To,motivation(conditions_not_verified)),_186557).
...
send_jasper_return_message(var_X,var_S,var_T,var_S0):-clause(agent(var_Ag),_186405),a(message(var_S,send_message(sent_rmi(var_X,var_T,var_S0),var_Ag))).

gest_learn(var_H):-clause(past(learn(var_H),var_T,var_U),_186353),learn_if(var_H,var_T,var_U).

evi(gest_learn(var_H)):-retractall(past(learn(var_H),_186229,_186231)),clause(agente(_186251,_186253,_186255,var_S),_186247),name(var_S,var_N),append(var_L,[46,112,108],var_N),name(var_F,var_L),manage_lg(var_H,var_F),a(learned(var_H)).

cllearn:-clause(agente(_186023,_186025,_186027,var_S),_186019),name(var_S,var_N),append(var_L,[46,112,108],var_N),append(var_L,[46,116,120,116],var_To),name(var_FI,var_To),open(var_FI,read,_186123,[]),repeat,read(_186123,var_T),arg(1,var_T,var_H),write(var_H),nl,var_T==end_of_file,!,close(_186123).
